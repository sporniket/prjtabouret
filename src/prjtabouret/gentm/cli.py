...
from .generator import buildAndWriteTechnicalMap


class TechnicalMapGeneratorCli:
    @staticmethod
    def createArgParser() -> ArgumentParser:
        # TODO Rewrite parser as needed
        parser = ArgumentParser(
            prog="python3 -m $$$.pp",
            description="Generate the technology map file of the Lattice GAL16V8 PLD and its drop-in replacement MicroChip (Atmel) ATF16V8.",
            epilog="""---
(c) 2024 David SPORN
---
This is part of prjtabouret -- Documenting the fusemap of the Lattice GAL16V8 PLD and its drop-in replacement MicroChip (Atmel) ATF16V8.
...
""",
        ...
        parser.add_argument(
            ...
            metavar="<path>",
            type=str,
            help="the path of the folder into which the techmap will be generated, missing folders in path are created.",
        )
    ...
    def run(self):
        try:
            args = TechnicalMapGeneratorCli.createArgParser().parse_args()
            ...
            # OK, proceed
            buildAndWriteTechnicalMap(args.root)
